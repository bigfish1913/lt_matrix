...
macro_rules! mcp_error {
    ($code:expr, $message:expr) => {
        $crate::mcp::protocol::errors::McpError::new($code, $message)
    };
    ($code:expr, $message:expr, $($key:expr => $value:expr),* $(,)?) => {{
        let mut error = $crate::mcp::protocol::errors::McpError::new($code, $message);
...
macro_rules! tool_error {
    ($tool:expr, $message:expr) => {
        $crate::mcp::protocol::errors::McpError::tool_execution($tool, $message)
    };
}
