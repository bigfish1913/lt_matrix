...
use crate::mcp::correlation::{PendingRequestHandle, RequestTracker};
use crate::mcp::protocol::errors::{McpError, McpErrorCode, McpResult};
use crate::mcp::protocol::messages::{JsonRpcMessage, JsonRpcNotification, JsonRpcRequest, JsonRpcResponse, RequestId};
use crate::mcp::protocol::wrappers::{McpMethod, McpMethodKind};
...
mod tests {
    use super::*;
    use crate::mcp::protocol::wrappers::{Initialize, Ping, ToolsList};
    use crate::mcp::protocol::{InitializeParams, InitializeResult, ImplementationInfo};
    use serde_json::json;
    use std::time::Duration;
    ...
    fn test_response_parser_parse_error_response() {
        ...
        let response = JsonRpcResponse::error(
            RequestId::Number(1),
            crate::mcp::protocol::errors::JsonRpcError::method_not_found("unknown"),
        );
