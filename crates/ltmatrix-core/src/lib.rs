...
pub struct Task {
    ...
    /// Agent type for this task (plan/dev/test/review)
    #[serde(default)]
    pub agent_type: AgentType,

    /// Priority of the task (0-9, higher is more important)
    #[serde(default = "default_priority")]
    pub priority: u8,

    /// Related task IDs for context reuse
    #[serde(default)]
...
impl ExecutionMode {
    ...
    /// Returns the agent types enabled for this mode
